...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars", r"C:\Users\PMLS\Desktop\Realtime-Voting-BDA\postgresql-42.7.5.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = (votes_per_candidate.selectExpr("to_json(struct(*)) AS value") 
        ...
        .option("checkpointLocation", r"C:\Users\PMLS\Desktop\Realtime-Voting-BDA\checkpoints\checkpoint1")
        .outputMode("update") 
        .start()
        )
    ...
    turnout_by_location_to_kafka = (turnout_by_location.selectExpr("to_json(struct(*)) AS value") 
        ...
        .option("checkpointLocation", "C:\\Users\\PMLS\\Desktop\\Realtime-Voting-BDA\\checkpoints\\checkpoint2") 
        .outputMode("update") 
        .start()
        )
    # Print the status of the streams
    print("Votes per candidate stream status:", votes_per_candidate_to_kafka.status)
    print("Turnout by location stream status:", turnout_by_location_to_kafka.status)
